        ...
        <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
          <div class="lg:flex lg:items-start lg:gap-8">
            <div class="text-teal-600">
              <img class="h-[90px] w-52" src={logo} alt="" />
            </div>
                ...
                <nav aria-label="Footer Navigation - Services" class="mt-6">
                  <ul class="space-y-4 text-sm">
                    <li>
                      <a
                        href="#"
                        class="text-gray-700 transition  hover:text-pink-500  delay-150 duration-200 ease-out"
                      >
                        1on1 Coaching
                      </a>
                    </li>
          ...
          <div class="pt-8 mt-8 border-t border-gray-100">
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
              <p class="text-xs text-left text-gray-500">
                &copy; 2022. Smart Field Service. All rights reserved.
              </p>
